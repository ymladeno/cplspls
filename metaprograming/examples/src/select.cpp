...
//struct nselect<0,T1,T2,T3,T4> { using type = T1; }; // specialize for N==0
//
//template<typename T1, typename T2, typename T3, typename T4>
//struct nselect<1,T1,T2,T3,T4> { using type = T2; }; // specialize for N==1
//
//template<typename T1, typename T2, typename T3, typename T4>
//struct nselect<2,T1,T2,T3,T4> { using type = T3; }; // specialize for N==2
//
//template<typename T1, typename T2, typename T3, typename T4>
//struct nselect<3,T1,T2,T3,T4> { using type = T4; }; // specialize for N==3
//
//template<int I, typename T1 =Nil, typename T2 =Nil, typename T3 =Nil, typename T4 =Nil>
//using Select = typename nselect<I,T1,T2,T3,T4>::type;
